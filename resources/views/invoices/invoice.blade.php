...
th, td {
    ...
    padding: 6px; /* Espaciado en celdas reducido */
    text-align: left;
    font-size: 0.8em; /* Tamaño de fuente en las celdas ajustado */
}
...
.company-name {
    font-weight: bold; /* Negrita */
    font-size: 1.2em; /* Tamaño de fuente del nombre de la empresa reducido */
...
.total {
    font-weight: bold;
    text-align: right;
    font-size: 1em; /* Tamaño de fuente para el total ajustado */
}
...
.footer {
    ...
    margin-top: 15px;
    color: #888;
    font-size: 0.7em; /* Tamaño de fuente para el pie de página más pequeño */
}
...
h3 {
    margin-top: 20px; /* Espacio superior para encabezados */
    font-weight: 700; /* Negrita */
    font-size: 1.2em; /* Tamaño de fuente para encabezados reducido */
