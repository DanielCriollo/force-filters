                ...
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" wire:model="searchCustomer"
                                wire:keyup="searchName" placeholder="Nombre del cliente">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-lg-12">
                                                <div class="form-group mt-2">
                                                    <label for="identification">Identificación: <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        wire:model="identification" placeholder="Identificación">
                                            ...
                                            <div class="col-lg-12 text-center">
                                                <button class="btn btn-success mt-3" wire:click="createCustomer">Crear
                                                    Cliente</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group input-group-sm">
                                                            <button class="btn btn-outline-secondary" type="button" wire:click="decrementQuantity({{ $index }})" @if($item['quantity'] <= 1) disabled @endif>-</button>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger btn-sm" title="Eliminar" wire:click="removeProduct({{ $index }})">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th>{{ number_format(array_sum(array_column($productsCart, 'quantity'))) }}
                                                </th>
                                                <th>{{ number_format(array_sum(array_column($productsCart, 'unitPrice')), 2, '.', ',') }}
                                                </th>
                                                <th>{{ number_format(array_sum(array_column($productsCart, 'subtotal')), 2, '.', ',') }}
                                                </th>
                                                <th></th>
                                            </tr>
                                        </tfoot>
